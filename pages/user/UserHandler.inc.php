...
class UserHandler extends Handler {
	...
	function setLocale($args) {
		...
		if (\OjsLocale::isLocaleValid($setLocale) && (!isset($journalSupportedLocales) || in_array($setLocale, $journalSupportedLocales)) && in_array($setLocale, $site->getSupportedLocales())) {
	...
	function authorizationDenied($args, &$request) {
		...
		$this->setupTemplate(true);
		\OjsLocale::requireComponents(array(LOCALE_COMPONENT_PKP_USER));
		$templateMgr =& TemplateManager::getManager();
	...
	function setupTemplate($subclass = false) {
		...
		\OjsLocale::requireComponents(array(LOCALE_COMPONENT_OJS_AUTHOR, LOCALE_COMPONENT_OJS_EDITOR, LOCALE_COMPONENT_OJS_MANAGER));
		$templateMgr =& TemplateManager::getManager();
		if ($subclass) {
