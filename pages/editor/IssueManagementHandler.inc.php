...
class IssueManagementHandler extends EditorHandler {
	 ...
	 */
	function setupTemplate($level = EDITOR_SECTION_HOME, $articleId = 0, $parentPage = NULL, $showSidebar = true) {
