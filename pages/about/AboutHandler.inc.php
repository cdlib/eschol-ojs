...
class AboutHandler extends Handler {
	...
	function index($args, &$request) {
		...
		if ($journalPath != 'index' && $journalDao->journalExistsByPath($journalPath)) {
			...
			if (isset($customAboutItems[\OjsLocale::getLocale()])) $templateMgr->assign('customAboutItems', $customAboutItems[\OjsLocale::getLocale()]);
			elseif (isset($customAboutItems[\OjsLocale::getPrimaryLocale()])) $templateMgr->assign('customAboutItems', $customAboutItems[\OjsLocale::getPrimaryLocale()]);
	...
	function setupTemplate($subclass = false) {
		...
		\OjsLocale::requireComponents(array(LOCALE_COMPONENT_OJS_MANAGER, LOCALE_COMPONENT_PKP_MANAGER));
	...
	function aboutThisPublishingSystem() {
		...
		foreach (array(\OjsLocale::getLocale(), $primaryLocale = \OjsLocale::getPrimaryLocale(), 'en_US') as $locale) {
