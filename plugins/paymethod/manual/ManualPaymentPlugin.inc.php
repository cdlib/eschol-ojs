...
class ManualPaymentPlugin extends PaymethodPlugin {
	...
	function getDisplayName() {
		return \OjsLocale::translate('plugins.paymethod.manual.displayName');
	}

	function getDescription() {
		return \OjsLocale::translate('plugins.paymethod.manual.description');
	}
		...
		switch ( $op ) {
			case 'notify':
				...
				$mail->assignParams(array(
					...
					'userFullName' => $user?$user->getFullName():('(' . \OjsLocale::translate('common.none') . ')'),
					'userName' => $user?$user->getUsername():('(' . \OjsLocale::translate('common.none') . ')'),
