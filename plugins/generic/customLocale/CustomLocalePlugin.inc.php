...
class CustomLocalePlugin extends GenericPlugin {
			...
			if ($this->getEnabled()) {
				...
				foreach ($localeFiles as $localeFile) {
					...
					if (FileManager::fileExists($customLocalePath)) {
						\OjsLocale::registerLocaleFile($locale, $customLocalePath, true);
					}
				}
	...
	function getDisplayName() {
		return \OjsLocale::translate('plugins.generic.customLocale.name');
	}

	function getDescription() {
		return \OjsLocale::translate('plugins.generic.customLocale.description');
	}
	...
	function getManagementVerbs($verbs = array()) {
		if ($this->getEnabled()) {
			$verbs[] = array('index', \OjsLocale::translate('plugins.generic.customLocale.customize'));
		}
