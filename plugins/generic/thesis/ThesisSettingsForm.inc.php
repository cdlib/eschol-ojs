...
class ThesisSettingsForm extends Form {
	...
	function __construct(&$plugin, $journalId) {
		...
		$this->validOrder = array (
			THESIS_ORDER_SUBMISSION_DATE_ASC => \OjsLocale::translate('plugins.generic.thesis.settings.order.submissionDateAsc'),
			THESIS_ORDER_SUBMISSION_DATE_DESC => \OjsLocale::translate('plugins.generic.thesis.settings.order.submissionDateDesc'),
			THESIS_ORDER_APPROVAL_DATE_ASC => \OjsLocale::translate('plugins.generic.thesis.settings.order.approvalDateAsc'),
			THESIS_ORDER_APPROVAL_DATE_DESC => \OjsLocale::translate('plugins.generic.thesis.settings.order.approvalDateDesc'),
			THESIS_ORDER_LASTNAME_ASC => \OjsLocale::translate('plugins.generic.thesis.settings.order.lastNameAsc'),
			THESIS_ORDER_LASTNAME_DESC => \OjsLocale::translate('plugins.generic.thesis.settings.order.lastNameDesc'),
			THESIS_ORDER_TITLE_ASC => \OjsLocale::translate('plugins.generic.thesis.settings.order.titleAsc'),
