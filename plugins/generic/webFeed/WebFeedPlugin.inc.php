...
class WebFeedPlugin extends GenericPlugin {
	...
	function getDisplayName() {
		return \OjsLocale::translate('plugins.generic.webfeed.displayName');
	}
	...
	function getDescription() {
		return \OjsLocale::translate('plugins.generic.webfeed.description');
	}
	...
	function getManagementVerbs($verbs = array()) {
		if ($this->getEnabled()) {
			$verbs[] = array('settings', \OjsLocale::translate('plugins.generic.webfeed.settings'));
		}
