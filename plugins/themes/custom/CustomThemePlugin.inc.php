...
class CustomThemePlugin extends ThemePlugin {
	...
	function getDisplayName() {
		return \OjsLocale::translate('plugins.theme.custom.name');
	}

	function getDescription() {
		return \OjsLocale::translate('plugins.theme.custom.description');
	}
	...
	function getManagementVerbs() {
		return array(array('settings', \OjsLocale::translate('plugins.theme.custom.settings')));
	}
