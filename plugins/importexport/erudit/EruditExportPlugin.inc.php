...
class EruditExportPlugin extends ImportExportPlugin {
	...
	function getDisplayName() {
		return \OjsLocale::translate('plugins.importexport.erudit.displayName');
	}

	function getDescription() {
		return \OjsLocale::translate('plugins.importexport.erudit.description');
	}
	...
	function executeCLI($scriptName, &$args) {
		...
		if (!$journal) {
			if ($journalPath != '') {
				echo \OjsLocale::translate('plugins.importexport.erudit.cliError') . "\n";
				echo \OjsLocale::translate('plugins.importexport.erudit.error.unknownJournal', array('journalPath' => $journalPath)) . "\n\n";
			}
		...
		if ($publishedArticle == null) {
			echo \OjsLocale::translate('plugins.importexport.erudit.cliError') . "\n";
			echo \OjsLocale::translate('plugins.importexport.erudit.export.error.articleNotFound', array('articleId' => $articleId)) . "\n\n";
			return;
		}
		...
		if (!isset($galley)) {
			echo \OjsLocale::translate('plugins.importexport.erudit.export.error.galleyNotFound', array('galleyLabel' => $galleyLabel)) . "\n\n";
			return;
		}
		$issue =& $issueDao->getIssueById($publishedArticle->getIssueId());
		if (!$this->exportArticle($journal, $issue, $publishedArticle, $galley, $xmlFile)) {
			echo \OjsLocale::translate('plugins.importexport.erudit.cliError') . "\n";
			echo \OjsLocale::translate('plugins.importexport.erudit.export.error.couldNotWrite', array('fileName' => $xmlFile)) . "\n\n";
		}
	}
	...
	function usage($scriptName) {
		echo \OjsLocale::translate('plugins.importexport.erudit.cliUsage', array(
