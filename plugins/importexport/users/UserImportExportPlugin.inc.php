...
class UserImportExportPlugin extends ImportExportPlugin {
	...
	function getDisplayName() {
		return \OjsLocale::translate('plugins.importexport.users.displayName');
	}

	function getDescription() {
		return \OjsLocale::translate('plugins.importexport.users.description');
	}
	...
	function executeCLI($scriptName, &$args) {
		...
		if (!$journal) {
			if ($journalPath != '') {
				echo \OjsLocale::translate('plugins.importexport.users.import.errorsOccurred') . ":\n";
				echo \OjsLocale::translate('plugins.importexport.users.unknownJournal', array('journalPath' => $journalPath)) . "\n\n";
			}
		...
		switch ($command) {
			case 'import':
				...
				// Success.
				echo \OjsLocale::translate('plugins.importexport.users.import.usersWereImported') . ":\n";
			...
			case 'export':
				...
				if (($h = fopen($xmlFile, 'wb'))===false) {
					echo \OjsLocale::translate('plugins.importexport.users.export.errorsOccurred') . ":\n";
					echo \OjsLocale::translate('plugins.importexport.users.export.couldNotWriteFile', array('fileName' => $xmlFile)) . "\n";
					return false;
				}
	...
	function usage($scriptName) {
		echo \OjsLocale::translate('plugins.importexport.users.cliUsage', array(
