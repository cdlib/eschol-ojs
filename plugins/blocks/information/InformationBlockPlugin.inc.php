...
class InformationBlockPlugin extends BlockPlugin {
	...
	function getDisplayName() {
		return \OjsLocale::translate('plugins.block.information.displayName');
	}
	...
	function getDescription() {
		return \OjsLocale::translate('plugins.block.information.description');
	}
	...
	function getContents(&$templateMgr) {
		...
		$templateMgr->assign('forLibrarians', $journal->getLocalizedSetting('librarianInformation'));
                $templateMgr->assign('contactEmail', $journal->getSetting('contactEmail'));
