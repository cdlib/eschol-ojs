...
class KeywordCloudBlockPlugin extends BlockPlugin {
	...
	function getDisplayName() {
		return \OjsLocale::translate('plugins.block.keywordCloud.displayName');
	}
	...
	function getDescription() {
		return \OjsLocale::translate('plugins.block.keywordCloud.description');
	}
	...
	function getContents(&$templateMgr) {
		...
		$cache =& $cacheManager->getFileCache('keywords_' . \OjsLocale::getLocale(), $journal->getId(), array(&$this, '_cacheMiss'));
