...
class METSGatewayPlugin extends GatewayPlugin {
	...
	function getDisplayName() {
		return \OjsLocale::translate('plugins.gateways.metsGateway.displayName');
	}

	function getDescription() {
		return \OjsLocale::translate('plugins.gateways.metsGateway.description');
	}
	...
	function getManagementVerbs() {
		...
		$verbs[] = array(
			'settings', \OjsLocale::translate('plugins.gateways.metsGateway.settings')
		);
		return $verbs;
	}
