...
mysqldump --defaults-file=~/.passwords/ojs_mysqldump.sql $DB_NAME --skip-lock-tables --skip-extended-insert --no-tablespaces > /apps/eschol/ojs/db_backup/ojs_db_dump.sql
